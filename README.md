...
## 💼 Perfil Profesional
* **Enfoque Cuantitativo:** Especialista en el control de métricas de desempeño, automatización de flujos de datos operativos y reducción de tiempos de procesamiento.
* **Formación:** 9.° semestre de la Licenciatura en Economía en la UNAM (SUAyED).
* **Experiencia:** Más de un año optimizando procesos de Workforce Management (WFM) y gestión de reportes masivos.
